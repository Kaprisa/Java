...
public class ToysCollection<T> implements Collection<T> {
    ...
    private class ElementsIterator implements Iterator<T> {
        ...
        public boolean hasNext() {
            return ToysCollection.this.size() > size;
        }

        @Override
        public T next() {
            return ToysCollection.this.m[size++];
        }
    }
}
